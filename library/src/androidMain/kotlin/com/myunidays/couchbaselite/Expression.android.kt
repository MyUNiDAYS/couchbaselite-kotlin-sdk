...
actual class Expression internal constructor(val android: com.couchbase.lite.Expression) {
    ...
    actual companion object {
        ...
        actual fun boolean(boolean: Boolean): Expression = Expression(com.couchbase.lite.Expression.booleanValue(boolean))
        ...
        actual fun not(expression: Expression): Expression = Expression(com.couchbase.lite.Expression.not(expression.android))
        actual fun negated(expression: Expression): Expression = Expression(com.couchbase.lite.Expression.negated(expression.android))
    }
}
